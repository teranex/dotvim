...
let g:Powerline#Colorschemes#trex#colorscheme = Pl#Colorscheme#Init([
	...
	\ Pl#Hi#Segments(['currenttag', 'fileformat', 'fileencoding', 'pwd', 'filetype', 'rvm:string', 'rvm:statusline', 'virtualenv:statusline', 'charcode', 'currhigroup'], {
		...
		\ }),
	\
	\ Pl#Hi#Segments(['lineinfo', 'bufnumber'], {
		\ 'n': ['gray2', 'gray10', ['bold']],
		\ 'N': ['gray7', 'gray1', ['bold']],
	...
	\ Pl#Hi#Segments(['errors'], {
		...
		\ }),
	\
	\ Pl#Hi#Segments(['lineinfo.line.tot', 'lineinfo.line.lines'], {
		\ 'n': ['gray6'],
		\ 'N': ['gray5'],
		\ 'i': ['darkestcyan'],
		\ }),
	\
	\ Pl#Hi#Segments(['paste_indicator', 'ws_marker', 'root_indicator'], {
